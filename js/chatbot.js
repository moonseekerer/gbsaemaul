...
3. 답변은 4~5문장 이내로 간결하게 작성하세요.`;
      ...
      if (hasOffTopic) {
        ...
        this.appendMessageTyping("안녕하세요. 경상북도 디지털새마을 AI 어드바이저입니다. 경북 시·군의 ODA 사업, 적정기술 매핑, 국제교류 현황에 특화된 안내를 제공하고 있습니다. 질문하신 주제는 어드바이징 범위 외 항목입니다. 디지털 새마을 ODA 프로젝트나 지자체 교류 현황에 대해 질문해 주시기 바랍니다.", 'bot');
        return;
      }
  ...
  generateResponse(query) {
    ...
    if (q.includes('영양') || q.includes('고추')) {
      ...
      return `[AI 어드바이저]\n경상북도 22개 시·군의 고유 자원(예: 칠곡의 에티오피아 참전보은, 영양의 고추 유기농법 등)을 기반으로, 3세대 디지털 새마을 정신을 접목한 최적의 글로벌 ODA 연계 방안을 안내합니다.`;
    }
  }
