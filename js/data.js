    ...
    members: [
      {
        ...
        intro: "한국국제협력단(KOICA) 피지 사무소 코디네이터로 현지 복무 중이며, 경상북도 22개 시·군 새마을 프로젝트 연계 이니셔티브 및 3세대 경상북도 디지털새마을 플랫폼 사업 총괄 기획자입니다.",
        education: [
          { period: "계명대학교 KAC", desc: "국제관계학과 (Department of International Relations)" }
        ],
        careers: [
          ...
          { period: "2019.08 - 2019.12", org: "KOICA", role: "국민서포터즈 WeKO 1기", desc: "대국민 대상 SDGs, KOICA 홍보 콘텐츠 제작 및 캠페인 수행" },
