...
const SAEMAUL_DATA = {
  platformInfo: {
    title: "글로벌 디지털 새마을 플랫폼 구축",
    subTitle: "기초 지자체 자산 데이터화 및 청년 아이디어 연계 3세대 새마을운동 가치 확산 플랫폼",
    category: "[기타 분야] 3세대 새마을운동 가치 확산에 기여할 수 있는 사업",
    members: [
      {
        name: "최윤진",
        role: "기획단 팀장",
        badge: "기획 총괄",
        title: "글로벌 디지털 새마을 프로젝트 기획 총괄 / KOICA 피지 코디네이터",
        intro: "한국국제협력단(KOICA) 피지 사무소 코디네이터로 현지 복무 중이며, 경상북도 22개 시·군 새마을 프로젝트 연계 이니셔티브 및 3세대 경상북도 디지털새마을 플랫폼 사업 총괄 기획자입니다. 유엔식량농업기구(FAO) 한국협회, 외교부 UN 안보리 청년사절, 한국국제교류재단(KF) 등 국제기구 및 다자외교 현장에서 축적한 전문성을 바탕으로, 경북 지자체의 고유 자산과 개도국 현장을 디지털 기술과 데이터로 연결하는 3세대 상생 모델을 총괄 지휘하고 있습니다.",
        awards: [
          "2026 AI 기반 새마을-SDGs 아이디어 공모전 대상 (기획 총괄)",
          "외교부 UN안보리 진출 대한민국 청년사절 표창 및 활동 수료",
          "한국국제교류재단 (KF) 글로벌 챌린저 아카데미 우수 수료"
        ],
        education: [
          { period: "계명대학교 KAC", desc: "국제관계학과 학사 (Department of International Relations)" },
          { period: "글로벌 챌린저", desc: "한국국제교류재단(KF) 글로벌 진출 전문 역량 교육 수료" }
        ],
        careers: [
          { period: "현재 (2025 - )", org: "한국국제협력단 (KOICA)", role: "KOICA 피지 코디네이터", desc: "피지 현지 ODA 사업 관리, 현지 사무소 운영 및 글로벌 개발협력 코디네이팅" },
          { period: "2023.02 - 2023.08", org: "유엔식량농업기구(FAO) 한국협회", role: "KOICA ODA YP", desc: "UN FAO 회의 대응, 의제 분석, KOICA 글로벌연수사업 중남미 공무원 연수 총괄 및 연사 의전, 국제기구 기사 번역 및 발간 지원" },
          { period: "2022.07 - 2023.01", org: "한국국제교류재단 (KF)", role: "글로벌 챌린저 아카데미", desc: "글로벌 진출 역량 함양 위한 국내 교육 및 해외연수 참여" },
          { period: "2022.06 - 2022.09", org: "외교부", role: "UN안보리 진출 청년사절", desc: "대한민국 UN 안보리 진출 홍보 및 지원, 기후변화 안보 관련 콘텐츠 제작" },
          { period: "2022.03 - 2022.08", org: "기후변화센터", role: "U-Savers 15기", desc: "기후변화 인식 제고 기획 및 콘텐츠 제작, 영리더십아카데미 참여" },
          { period: "2021.09 - 2021.12", org: "외교부 / 운영사무국", role: "서울UN평화유지장관회의 청년 Peacekeeper", desc: "외교부·국방부·UN 협력 장관회의 홍보, 취재 및 협업" },
          { period: "2021.03 - 2021.12", org: "한·아프리카재단", role: "3기 청년서포터즈", desc: "아프리카 인식 개선 및 제고 콘텐츠 제작, 재단 사업 참여 및 홍보" },
          { period: "2019.03 - 2022.08", org: "계명대학교 영자신문사", role: "기자 / 편집국장", desc: "취재 및 신문발행 총괄, 기자 대상 교육" },
          { period: "2019.08 - 2019.12", org: "한국국제협력단 (KOICA)", role: "국민서포터즈 WeKO 1기", desc: "대국민 대상 SDGs, KOICA 홍보 콘텐츠 제작 및 캠페인 수행" },
          { period: "2023", org: "한국간담췌외과학회 / 국제이차전지포럼", role: "학회/포럼 의전", desc: "제7차 영남-간사이 HBP 심포지엄 및 국제이차전지포럼 회의장 진행 및 연사 의전" }
        ],
        projects: [
          { agency: "외교부 (KOICA)", title: "피지 현지 ODA 사업 총괄 관리 및 현지 사무소 운영", period: "2025.01 - 현재" },
          { agency: "유엔식량농업기구 (FAO)", title: "KOICA 글로벌연수사업 중남미 공무원 초청 연수 총괄 및 의제 분석", period: "2023.02 - 2023.08" },
          { agency: "외교부", title: "대한민국 UN 안보리 진출 이니셔티브 및 기후변화 안보 프로젝트", period: "2022.06 - 2022.09" },
          { agency: "한국국제교류재단 (KF)", title: "글로벌 챌린저 공공외교 역량 개발 및 해외 연수", period: "2022.07 - 2023.01" },
          { agency: "외교부 / 국방부 / UN", title: "2021 서울 UN 평화유지장관회의(UN PKO) 다자협력 및 의전", period: "2021.09 - 2021.12" },
          { agency: "한·아프리카재단", title: "한-아프리카 개발협력 파트너십 증진 및 인식 개선 프로젝트", period: "2021.03 - 2021.12" },
          { agency: "경상북도 / 기획단", title: "3세대 경상북도 디지털새마을 플랫폼 글로벌 사업 기획 총괄", period: "2026.01 - 현재" }
        ],
        footprint: {
          "오세아니아 (피지/태평양)": ["피지 (Fiji 현지 사무소 상주 복무)"],
          "아시아 / 다자국제기구": ["대한민국 (UN/외교부 연계)", "일본 (영남-간사이 국제포럼 교류)"],
          "글로벌 파트너십 연계": ["UN FAO 회원국 (중남미 연수 대상국)", "한·아프리카 교류국", "UN 평화유지 참여국"]
        }
      },
      {
        name: "박문식",
        role: "팀원",
        badge: "기획단 팀원",
        title: "경북테크노파크 글로벌협력실 전임연구원 / 영남대 대학원 새마을국제개발학과 박사과정",
        intro: "박문식 연구원은 학술적 전문성과 글로벌 현장 실무 경험을 겸비한 국제개발협력 전문가입니다. 에티오피아 섬유 테크노파크 조성 지원사업, 우즈베키스탄 IT Park PMC 사업 등 공적개발원조(ODA) 프로젝트를 성공적으로 이끌며 개발도상국의 산업 경쟁력 강화와 SDGs 달성에 앞장서고 있습니다. 특히 우즈베키스탄 IT Park PMC 사업을 탁월하게 수행하여 2025년 KOICA 이사장 명의 감사패(우수 파트너상)를 수상하며 사업 관리 및 실무 기획 역량을 공식 인정받았습니다. 미얀마, 라오스, 인도네시아 등 다양한 현장에서 쌓아온 깊은 통찰력을 바탕으로 실효성 있는 글로벌 상생 협력을 실천하고 있습니다.",
        awards: [
          "2025 KOICA (한국국제협력단) 이사장 감사패 (우수 파트너상 수상 - 우즈베키스탄 IT Park PMC 사업)",
          "2026 AI 기반 새마을-SDGs 아이디어 공모전 대상 (1위)"
        ],
        education: [
          { period: "2026.03 - 현재", org: "영남대학교 대학원", role: "새마을국제개발학과", desc: "박사과정 재학 (박사 1기)" },
          { period: "2020.03 - 2026.02", org: "영남대학교 대학원", role: "새마을국제개발학", desc: "석사 졸업" },
          { period: "2016.03 - 2020.02", org: "영남대학교", role: "새마을국제개발학", desc: "학사 졸업" }
        ],
        careers: [
          { period: "2023.07 - 현재", org: "경북테크노파크", role: "글로벌협력실 전임연구원", desc: "국제개발협력 사업 기획 및 실무 전담" },
          { period: "2025", org: "한국국제협력단 (KOICA)", role: "우수 파트너상 수상", desc: "우즈베키스탄 IT Park PMC 사업 우수 수행 공로 KOICA 이사장 감사패 수상" },
          { period: "2019", org: "영국 사회적기업 (Social Enterprise)", role: "연구원", desc: "현지 조사 연구" },
          { period: "2018", org: "LG전자", role: "CSR Field Study", desc: "미얀마 현지 필드 스터디" },
          { period: "2018", org: "현대자동차", role: "해피무브 글로벌 청년봉사단 18기", desc: "라오스 지역 봉사" },
          { period: "2017", org: "인도네시아 ODA", role: "실무 인턴십", desc: "국제개발협력 실무 인턴십 활동" },
          { period: "2017", org: "베트남국립농업대학 (VNUA)", role: "대학 교류", desc: "대학교류 및 해외새마을운동 현장 견학" },
          { period: "2017", org: "경상북도", role: "대학생 새마을 해외봉사단", desc: "키르기스스탄 해외봉사" },
          { period: "2016 - 2018", org: "필리핀 Enderun Colleges", role: "대학 교류", desc: "주요 대학 교류 및 대외 활동" }
        ],
        projects: [
          { agency: "산업부 (KIAT)", title: "에티오피아 섬유테크노파크 조성 지원사업", period: "2018.06 - 2023.12" },
          { agency: "산업부 (KIAT)", title: "개도국 섬유분야 생산현장 애로기술지도 (타지키스탄)", period: "2021.05 - 2023.12" },
          { agency: "산업부 (KIAT)", title: "개도국 섬유분야 생산현장 애로기술지도 (캄보디아)", period: "2021.05 - 2023.12" },
          { agency: "외교부 (KOICA)", title: "우즈베키스탄 IT Park 지속성장 기반조성 및 역량강화 PMC", period: "2021.10 - 2025.12" },
          { agency: "산업부 (KIAT)", title: "엘살바도르 디지털전환분야 현장 애로기술지도", period: "2023.05 - 2027.12" },
          { agency: "산업부 (KIAT)", title: "과테말라 섬유 TASK센터 조성 지원", period: "2024.05 - 2027.12" },
          { agency: "경상북도", title: "2024 경상북도 과테말라 기계전 및 판촉전", period: "2024.03 - 2024.12" }
        ],
        footprint: {
          "아시아 (19개국/지역)": ["한국", "우즈베키스탄", "타지키스탄", "캄보디아", "미얀마", "베트남", "인도네시아", "필리핀", "라오스", "키르기스스탄", "말레이시아", "싱가포르", "일본", "중국", "카자흐스탄", "태국", "튀르키예", "홍콩", "마카오"],
          "유럽 (7개국)": ["영국", "네덜란드", "오스트리아", "러시아", "헝가리", "덴마크", "체코"],
          "아메리카 (3개국)": ["과테말라", "미국", "캐나다"],
          "오세아니아 (2개국)": ["호주", "피지"],
          "아프리카 (1개국)": ["에티오피아"]
        }
      }
  ...
  gyeongbukCities: {
    "청도군": {
        ...
        "project": "새마을 발상지 정신 계승 및 글로벌 자조형 에코 마을 프로젝트",
        "desc": "발상지 청도의 주민 협동 노하우를 베트남·스리랑카 등 개도국 마을기업과 직접 연결하여 주민 자립 생태계를 확장합니다.",
        "matching3Axis": {
            "senior": "[시니어] 신도리 발상지 협동 노하우 & 청도 감·버섯 농특산품 생산 자원 전수",
    ...
    "포항시": {
        ...
        "project": "해양 적정기술 및 2차전지 에코 마을기업 프로젝트",
    ...
    "구미시": {
        ...
        "project": "스마트 IT 센서 및 개도국 청년 디지털 센터 프로젝트",
        ...
        "matching3Axis": {
            ...
            "global": "[글로벌] 구미 소재 (사)새마을재단 해외 10개국 사무소 및 금오공대 외국인 유학생 매핑"
        }
    },
    "경산시": {
    ...
    "칠곡군": {
        ...
        "project": "참전 보은 평화 새마을 & 자립형 농촌 마을기업 프로젝트",
    ...
    "안동시": {
        ...
        "project": " 3세대 디지털 새마을 광역 거점 & AI 거버넌스",
        ...
        "matching3Axis": {
            ...
            "global": " [글로벌] 경북도청 해외 자매도시 연계망 및 안동 거주 외국인 유학생 매핑"
        }
    },
    "경주시": {
        ...
        "project": " 역사문화유산 스마트 보존 & 농가소득 증대 프로젝트",
    ...
    "울진군": {
        ...
        "project": "무탄소 청정 에너지 & 해수담수화 적정기술 매핑 프로젝트",
    ...
    "울릉군": {
        ...
        "project": "독도 해양 생태 보존 & 도서 어촌 수산 자립 새마을 프로젝트",
    ...
    "영양군": {
        ...
        "project": "청정 유기 농업 & 토양 보존형 스마트 영농 프로젝트",
